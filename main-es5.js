...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppGoogleSheetServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var URL_BASE = 'https://sheets.googleapis.com/v4/spreadsheets/1fixYeV2RO49tlewNUQftKnniUmQSkgcOgZQZK6bWUwM/values/';
    var CLIENT_ID = '89504646880-gch485mqj3s7gn4lijlmnhvj2calj08m.apps.googleusercontent.com';
    var API_KEY = 'AIzaSyBfcOTbKzOxZZ49LFa_IJFia4NXxdRo6oY'; // Array of API discovery doc URLs for APIs used by the quickstart

    var DISCOVERY_DOCS = ["https://sheets.googleapis.com/$discovery/rest?version=v4"]; // Authorization scopes required by the API; multiple scopes can be
    ...
    var GoogleSheetService = /*#__PURE__*/function () {
      function GoogleSheetService( // private scriptService: ScriptService,
      http) {
      ...
      _createClass(GoogleSheetService, [{
        key: "getCSVGoals",
        value: function getCSVGoals() {
          var range = 'Sheet1!A2:D10';
          var url = "".concat(URL_BASE).concat(range, "?key=").concat(API_KEY);
          return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (v) {
            return v.values;
  ...
  function srcAppHomeHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_assets_data_mygoals__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! src/assets/data/mygoals */
    ...
    var _skill_levels_skill_levels_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ../skill-levels/skill-levels.component */
    "./src/app/skill-levels/skill-levels.component.ts");
    /* harmony import */


    var _goals_tracking_goals_tracking_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ../goals-tracking/goals-tracking.component */
    "./src/app/goals-tracking/goals-tracking.component.ts"); // import goals from 'src/assets/data/mygoals.json'
    ...
    function HomeComponent_section_72_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function HomeComponent_section_74_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function HomeComponent_section_76_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var HomeComponent = /*#__PURE__*/function () {
      function HomeComponent(idle, scully, router, googleSheetService, ref, ngZone) {
        ...
        this.myGoals$ = this.googleSheetService.getCSVGoals().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (values) {
          console.log(values);
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](HomeComponent, [{
        ...
        return [{
          type: _scullyio_ng_lib__WEBPACK_IMPORTED_MODULE_4__["IdleMonitorService"]
        }, {
  ...
  /***/
  function srcAssetsDataMygoalsTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var goals = {
      "goals": [{
        ...
        "label": "GCP fundamentals course",
        "progress": 30
      }, {
        "label": "Leme/Copa swim (~3.6km)",
        "progress": 65
      }]
    };
    /***/
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /home/caio/Projects/PersonalSiteScully/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
